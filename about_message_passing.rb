...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # Classes may wish to override send for purposes other than message
    # passing.
  end
  ...
  def test_classes_can_be_asked_if_they_know_how_to_respond
    ...
    assert !mc.respond_to?(:does_not_exist)
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # We could dynamically route method names to use other methods,
    # or even define the function itself in the code of the method_missing
    # override.
    #
    # NOTE:
    #
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    assert !catcher.respond_to?(:any_method)
  end
  ...
  def test_explicitly_implementing_respond_to_lets_objects_tell_the_truth
    ...
    assert !catcher.respond_to?(:something_else)
  end
