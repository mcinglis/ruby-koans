...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_a_failed_match_returns_nil
    assert "some matching content"[/missing/].nil?
  end
  ...
  # Why?
  #
  # Because they match as much of the string as they can.
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    assert "start end"[/\Aend/].nil?
  end

  def test_slash_z_anchors_to_the_end_of_the_string
    assert_equal 'end', "start end"[/end\z/]
    assert "start end"[/start\z/].nil?
  end
  ...
  # (|).
  # Character classes are a shorthand for defining a set of alternations.
  # (James|Dana|Summer) == [(James)(Dana)(Summer)]
