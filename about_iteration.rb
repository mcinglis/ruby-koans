...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # For inject(a) { |x,y| ... }, it initially passes the value of a
    # into x, and the first element of the list into y. Then, on the next
    # iteration, x will be the result of the first block execution, and y
    # will be the second element. So on and so forth.
    # AKA foldl
  end
  ...
  #
  # Because we would then need to close the file - whereas we can have the
  # File object manage this automatically for us by passing in a block.
